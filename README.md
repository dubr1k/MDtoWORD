...
1. **Скачайте проект**
2. **Дважды кликните** по файлу `запуск_конвертера.bat`
3. **Готово!** Программа автоматически установит зависимости и запустится
...
├── 🚀 запуск_конвертера.bat      # Быстрый запуск для Windows
├── 📖 README.md                  # Документация (этот файл)
├── 📝 test_example.md            # Пример Markdown файла
